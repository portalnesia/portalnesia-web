...
const Button=React.forwardRef<HTMLButtonElement,ButtonProps>((props,ref)=>{
    const {size="small",loadingPosition: loadingPosisi,disabled=false,outlined=false,children="",color="primary",variant="contained",tooltip,text,style,endIcon,icon,tooltipProps={interactive:true,enterTouchDelay:100},loading,isloading,...other}=props
        ...
        return(
                <Tooltip title={tooltip} {...tooltipProps}>
                    <Buttonn
                        ...
                        {...(outlined ? {variant:'outlined',color:'grey'} : text ? {variant:'text',color:'grey'} : {variant,color})}
                        ref={ref}
